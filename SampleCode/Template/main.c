...
#define LINKER_VAR_ZI	        Image$$RW_IRAM1$$ZI$$Length
...
void get_binary_size(void)
{
    /*
        https://blog.csdn.net/booksyhay/article/details/106556326
    */
    int *pBase, *pLimit;
    int size_RO1;
    int size_RO2;
    ...
    size_RO1 = (int)pLimit - (int)pBase;
    size_RO2 = (int)&LINKER_VAR;
    size_RW = (int)&LINKER_VAR_RW;
    size_ZI = (int)&LINKER_VAR_ZI;
    
    printf("RO1:%4d,0x%08X\r\n" , size_RO1 , size_RO1);
    printf("RO2:%4d,0x%08X\r\n" , size_RO2 , size_RO2);
    printf("RW:%4d,0x%08X\r\n" , size_RW , size_RW);
    printf("ZI:%4d,0x%08X\r\n" , size_ZI , size_ZI);
    printf("ROM size:%4d (Code+RO:%d,RW:%d)\r\n",size_RO1+size_RW,size_RO1,size_RW);
    printf("RAM size:%4d (RW:%d,ZI:%d)\r\n",size_RW+size_ZI,size_RW,size_ZI);
